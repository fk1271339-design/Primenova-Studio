  ...
  return (
    <div className="min-h-[85vh] w-full flex items-center justify-center pt-32 pb-16 px-4">
      <motion.div
        ...
        className="w-full max-w-md p-8 rounded-3xl liquid-glass border border-foreground/10 shadow-2xl relative overflow-hidden"
      >
        {/* Glow Effects */}
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold font-display text-foreground tracking-tight">Welcome Back</h1>
          <p className="text-sm text-muted-foreground mt-2 font-light">
            Sign in to access your PrimeNova dashboard and AI history
          </p>
        </div>
        ...
        <div className="flex items-center my-6">
          ...
          <span className="px-4 text-xs text-muted-foreground uppercase font-mono tracking-widest">or email</span>
          <div className="flex-1 border-t border-foreground/10" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="w-full py-4 rounded-2xl bg-gradient-to-r from-amber-400 via-orange-400 to-rose-500 text-black font-semibold text-sm hover:opacity-90 shadow-lg shadow-amber-500/20 transition-all duration-300 active:scale-98 disabled:opacity-50 mt-2 flex items-center justify-center gap-2"
          >
            {isSubmitting ? (
